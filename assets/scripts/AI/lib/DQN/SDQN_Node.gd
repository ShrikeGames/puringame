...
@export_range(0,1,0.01) var discount_factor: float = 0.99
...
@export var target_update_frequency: int = 32
## The maximum size of the replay memory.
@export var max_memory_size: int = 12800
...
@export_range(0,1,0.0001) var min_exploration_probability: float = 0.05
## The rate at which the exploration probability decays. This is multiplied with the exploration probability every max_steps.
@export_range(0,1,0.0001) var exploration_decay: float = 0.995
